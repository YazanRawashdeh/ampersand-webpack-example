const template = require('../templates/collection.hbs');
const PageView = require('./base');
const PostView = require('../views/post');

module.exports = PageView.extend({
    pageTitle: 'POSTS DEMO',
    template: template,
    events: {
    ...
    render: function () {
        ...
        this.renderCollection(this.collection, PostView, this.queryByHook('posts-list'));
